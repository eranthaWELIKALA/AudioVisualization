...
function setup() {
    ...
    playButton.position(windowWidth/2-playButton.width/2,windowHeight-100);
    backwardButton.position(windowWidth/2-playButton.width/2-backwardButton.width,windowHeight-100);
...
function draw(){
    ...
    mapMouseX = map(val, 0, width, 1, 50);
    mapMouseXbass = map(val, 0, width, 1, 5);
    mapMouseY = map(val, 0, height, 2, 6);

...
function setup() {
    ...
    input = createFileInput(uploaded);input.parent('p5');
    input.style('width','180px');
    input.position(220,windowHeight/2);

    backwardButton = createButton('');backwardButton.parent('p5');
    backwardButton.style('width','70px');
    backwardButton.position(input.x+input.width,windowHeight/2);
    backwardButton.mousePressed(backwardSong);

    playButton = createButton('Play..');playButton.parent('p5');
    playButton.style('width','80px');
    playButton.position(backwardButton.x+backwardButton.width,windowHeight/2);
    playButton.mousePressed(tooglePlay);

    forwardButton = createButton('');forwardButton.parent('p5');
    forwardButton.style('width','70px');
    forwardButton.position(playButton.width+playButton.x,windowHeight/2);
    forwardButton.mousePressed(forwardSong);

    patternButton = createSelect();patternButton.parent('p5');
    patternButton.style('width','150px');
    ...
    patternButton.position(forwardButton.width+forwardButton.x,windowHeight/2);
